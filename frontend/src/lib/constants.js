export const DEMO_STEP_TITLES = {
  1: "Minute 1: Zero-State Profile Ingestion",
  2: "Minute 2: Autonomous Trend Filtering (Scout Mind)",
  3: "Minute 3: Multi-Mind Strategy Synthesis (Core + Community)",
  4: "Minute 4: Autonomous Business Execution (Business Mind)",
  5: "Minute 5: Proof of Learning ('The Magic Moment')"
};

export const DEMO_STEP_DESCRIPTIONS = {
