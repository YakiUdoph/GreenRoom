...
const lifecycle = [
  ...
  ['04 — DECISION', 'The conservative deterministic core evaluates the evidence against the objective and Memory.'],
...
function SectionBody({ id }) {
  ...
  if (id === 'mind') return <><DocHead label="VERIFIED PLATFORM IDENTITY" title="Udophia remains available without obscuring provenance."/><p>Udophia is the only verified platform Mind: <code>udophia@hellominds.ai</code>, UUID <code>8208493e-f36b-1410-8466-00039ce7df11</code>. The official Builder identity, conversation, SSE, and history integration remains in the product.</p><p>The normal live-evidence briefing is currently generated by GreenRoom’s deterministic live core because verified Udophia replies are not reliable enough to be a mandatory completion dependency. A briefing says Minds generated it only when a verified reply actually did.</p></>;
