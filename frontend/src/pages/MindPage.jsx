...
export function MindPage({ memoryState, isExecuting }) {
  ...
  return <div className="rich-route mind-route">
    ...
    <section className="density-shell">
      ...
      <div className="mind-identity-block"><p>CONNECTED MIND CAPABILITY</p><h2>GreenRoom Mind Connection</h2><div className="mind-capability-copy">The GreenRoom Mind is your persistent AI companion. It interprets verified live evidence against your saved preferences and objectives to deliver personalized, structured briefings. Technical details (Mind ID: 8208493e-f36b-1410-8466-00039ce7df11) remain inspectable in the system diagnostics.</div></div>
    </section>
  </div>;
}
