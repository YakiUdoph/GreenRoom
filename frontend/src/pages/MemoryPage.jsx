...
export function MemoryPage({ memoryState, onSubmitFeedback, onOpenOnboarding, isExecuting }) {
  ...
  return <div className="rich-route memory-route">
    <section className="route-visual-hero"><img src="/assets/greenroom-creator-night.png" alt="Creator at work"/><div className="route-visual-copy"><p>MY MEMORY</p><h1>What helps GreenRoom decide for you.</h1><span>Your useful preferences, constraints, and feedback carry forward to make later decisions more relevant.</span></div><div className="route-visual-meta"><span>Remembers {memories.length} preference{memories.length === 1 ? '' : 's'}</span><span>Your Mind ✓ Connected</span></div></section>
